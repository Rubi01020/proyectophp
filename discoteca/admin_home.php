...
<head>
    ...
    <title>Aurora Club - Administrador</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="gestion_personal.php">Personal</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="gestion_usuarios.php">Usuarios</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-4">
        ...
        <p class="text-center">Selecciona una opción en la barra de navegación para gestionar las distintas secciones.</p>
    </div>
